...
print("🔄 Generando embeddings de artículos con BioBERT...")
embeddings_cfs = embed_texts(articulos)

print("🔄 Generando embeddings de queries con BioBERT...")
embeddings_queries = embed_texts(queries)
